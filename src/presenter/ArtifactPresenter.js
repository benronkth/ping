...
import { getNewGainDamageTakenArtifact, getNewDecreaseDamageTakenArtifact, getNewRocketArtifact, getNewAtomRocketArtifact, getNewHRocketArtifact, getNewRandomPositionArtifact, getNewInvertInputArtifact, getNewExpoArtifact } from "../model/Elements";
    ...
    useEffect(() => {
        ...
        if (isGameStarted && gameOwnerId === playerId) {
            ...
            const ref = setInterval(() => {
                ...
                tempArtifacts.push(getNewExpoArtifact({
                    position: {
                        r: randomRow,
                        c: randomColumn
                    }
